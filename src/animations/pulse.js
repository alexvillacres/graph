...
export function animatePulse(
  ...
  timeline
    ...
    .to(
      stops[0],
      { attr: { offset: endOffset[0] }, delay: 0.2, duration: 3 },
      0,
    )
    .to(
      stops[1],
      { attr: { offset: endOffset[1] }, delay: 0.2, duration: 3 },
      0,
    )
    .to(
      stops[2],
      { attr: { offset: endOffset[2] }, delay: 0.2, duration: 3 },
      0,
    )
    .to(
      stops[3],
      { attr: { offset: endOffset[3] }, delay: 0.2, duration: 3 },
      0,
    );
}
